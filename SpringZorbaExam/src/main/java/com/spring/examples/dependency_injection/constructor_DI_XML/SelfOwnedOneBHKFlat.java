...
public class SelfOwnedOneBHKFlat {
    ...
    public float finalPriceOfFlat(float length, float breadth, float height) {
        float price =  10000 * calculatePlot(length, breadth, height);
        System.out.println("Price of self owned One BHK flat for length="+ length +" breadth="+breadth+" height="+height+" is = "+ price);
        return price;
    }
